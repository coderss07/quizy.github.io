(function () {
	"use strict";
    alert('aman');
    let teacherForm = document.getElementById('teacher-register-form')
	...
	teacherForm.addEventListener('submit', function(event) {
        ...
        let password = thisForm.querySelector('#password').value;
        let cpassword = thisForm.querySelector('#c-password').value;
        thisForm.onreset = () => {
            thisForm.querySelector('.error-message').classList.remove('d-block');
        }
